...
<html style="width: 100%; height: 100%;">
  <head>
    ...
    <!--                                           -->
    <script type="text/javascript" language="javascript" src="Calendar/Calendar.nocache.js"></script>
    <style>
      td {
        text-align: left;
      }
  ...
  <body style="margin: 0px; padding: 0px; width: 100%; height: 100%;">
    ...
    <div id="loadingProgress" class="jepRia-loadingProgress">
      <div class="jepRia-loadingIndicator">
        <img src="images/loading.gif" width="32" height="32" alt="Loading..."/>
          <div>
            <p>
              <span id="loadingHeader">Calendar</span>
            </p>
    ...
    <link type="text/css" rel="stylesheet" property='stylesheet' href="css/Calendar.css" />
  </body>
</html>
