...
public class UseFTPSWithoutServerValidation {
    ...
    public static void main(String[] args) {
        ...
        String filename = "UseFTPSWithoutServerValidation.java";

        // set up logger so that we get some output
        Logger log = Logger.getLogger(UseFTPSWithoutServerValidation.class);
