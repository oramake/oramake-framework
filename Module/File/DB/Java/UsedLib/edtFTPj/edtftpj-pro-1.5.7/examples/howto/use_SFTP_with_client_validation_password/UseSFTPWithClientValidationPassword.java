...
public class UseSFTPWithClientValidationPassword {
    ...
    public static void main(String[] args) {
        ...
        String filename = "UseSFTPWithClientValidationPassword.java";

        // set up logger so that we get some output
        Logger log = Logger
                .getLogger(UseSFTPWithClientValidationPassword.class);
