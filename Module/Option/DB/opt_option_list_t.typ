...
/* group: Получение значения параметра в SQL */
...
/* group: Дополнительные функции изменения данных */
...
/* pfunc: clearCache
  Очищает кэшированные значения параметров, относящихся к текущему набору
  параметров. Кэшированные значения используются в функциях получения значения
  параметра (например, <getDate>) при указании useCacheFlag равного 1.
