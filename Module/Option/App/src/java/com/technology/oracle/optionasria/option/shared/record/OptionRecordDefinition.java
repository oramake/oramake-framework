package com.technology.oracle.optionasria.option.shared.record;
...
public class OptionRecordDefinition extends JepRecordDefinition {
	...
	private static Map<String, JepTypeEnum> buildTypeMap() {
		...
		typeMap.put(OBJECT_SHORT_NAME, STRING);
		typeMap.put(OBJECT_TYPE_ID, INTEGER);
		typeMap.put(OBJECT_TYPE_NAME, STRING);
		...
		typeMap.put(OPTION_VALUE, STRING);
		...
		typeMap.put(OBJECT_TYPE_SHORT_NAME, STRING);
		...
		typeMap.put(IS_EDIT_VALUE, BOOLEAN);
		typeMap.put(ACCESS_LEVEL_NAME, STRING);
		typeMap.put(MODULE_SVN_ROOT, STRING);
	...
	private static Map<String, JepLikeEnum> buildLikeMap() {
		...
		likeMap.put(OBJECT_SHORT_NAME, CONTAINS);
