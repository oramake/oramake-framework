...
public class BatchRoleClientFactoryImpl
extends StandardClientFactoryImpl<PlainEventBus, BatchRoleServiceAsync> {
  ...
  private BatchRoleClientFactoryImpl() {
    super(BATCHROLE_MODULE_ID, BatchRoleRecordDefinition.instance);
  }
...
public JepPresenter createPlainModulePresenter(Place place) {
  ...
  @Override
  public BatchRoleServiceAsync createService() {
    return GWT.create(BatchRoleService.class);
  }
}
