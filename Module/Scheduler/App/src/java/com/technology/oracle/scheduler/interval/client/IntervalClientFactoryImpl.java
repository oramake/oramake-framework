...
public class IntervalClientFactoryImpl
extends StandardClientFactoryImpl<PlainEventBus, IntervalServiceAsync> {
  ...
  private IntervalClientFactoryImpl() {
    super(INTERVAL_MODULE_ID, IntervalRecordDefinition.instance);
  }
...
public JepPresenter createPlainModulePresenter(Place place) {
  ...
  @Override
  public IntervalServiceAsync createService() {
    return GWT.create(IntervalService.class);
  }
}
