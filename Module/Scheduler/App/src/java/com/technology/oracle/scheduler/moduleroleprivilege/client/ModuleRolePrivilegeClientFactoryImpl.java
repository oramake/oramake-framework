...
public class ModuleRolePrivilegeClientFactoryImpl
extends StandardClientFactoryImpl<PlainEventBus, ModuleRolePrivilegeServiceAsync> {
  ...
  private ModuleRolePrivilegeClientFactoryImpl() {
    super(MODULEROLEPRIVILEGE_MODULE_ID, ModuleRolePrivilegeRecordDefinition.instance);
  }
...
public JepPresenter createPlainModulePresenter(Place place) {
  ...
  @Override
  public ModuleRolePrivilegeServiceAsync createService() {
    return GWT.create(ModuleRolePrivilegeService.class);
  }
}
