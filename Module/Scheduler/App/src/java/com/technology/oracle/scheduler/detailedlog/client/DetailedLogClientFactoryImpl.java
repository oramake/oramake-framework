...
public class DetailedLogClientFactoryImpl
extends StandardClientFactoryImpl<PlainEventBus, DetailedLogServiceAsync> {
  ...
  private DetailedLogClientFactoryImpl() {
    super(DETAILEDLOG_MODULE_ID, DetailedLogRecordDefinition.instance);
  }
...
public JepPresenter createPlainModulePresenter(Place place) {
  ...
  @Override
  public DetailedLogServiceAsync createService() {
    return GWT.create(DetailedLogService.class);
  }
}
