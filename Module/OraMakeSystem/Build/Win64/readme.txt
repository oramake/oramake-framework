...
- unix2dos
    (для возможности установки модулей с версией OMS-файлов ниже 2.4.0,
    использовался в DB/OmsModule/common.mk при логировании установки)
...
- набор пакетов, используемых в дистрибутиве MinGit-2.30.0.2-64-bit.zip,
  ...
  дистрибутив загружен из https://github.com/git-for-windows/git/releases)
