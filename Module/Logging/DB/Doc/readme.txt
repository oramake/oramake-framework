...
правила: в случае вывода в лог сообщения (согласно правилу выше)
обеспечивается предварительный вывод сообщений по открытию действующих
контекстов выполнения (независимо от их уровней); если было выведено сообщение
по открытию контекста выполнения, то будет выведено и сообщение по закрытию
этого контекста выполнения (независимо от его уровня).
