...
--                               ( для выдачи прав всем пользователям нужно
--                                 указать "public")
--
-- Замечания:
--  - скрипт запускается под пользователем, которому принадлежат объекты модуля;
--  - кроме выдачи прав также создаются синонимы ( личные или публичные при
--    выдаче прав всем пользователям) на объекты модуля;
--
--
