...
использования в прикладных модулях. Также, в модуль добавлена функция
...
для хранилища, реализован специальный объектный интерфейс
( см. <Интерфейсные таблицы>, <Реализация модуля интерфейсных таблиц>).

Процедуры обновления материализованных представлений:

1. <Обновление мат. представлений по списку, либо всех в указанных схемах>
...
group: Обновление мат. представлений по списку, либо всех в указанных схемах
...
- с целью обхода ограничения размерности varchar2(4000) в случае формирования
  списка мат. представлений по переданным именам схем, наименования найденных
  мат. представлений размещаются в массиве типа dbms_utility.uncl_array,
  передаваемый далее в качестве параметра в вызов dbms_mview.refresh( tab => ...).
